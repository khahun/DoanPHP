...
$sql = "SELECT s.*, a.Anh1, d.TenDM, n.TenNCC 
        ...
        WHERE n.TenNCC = 'ADIDAS' AND d.TenDM LIKE '%DÉP%'";
...
$sql = "SELECT sp.MaSP, sp.TenSP, sp.DonGia, sp.AnhNen
        ...
        WHERE ncc.TenNCC = 'ADIDAS' AND sp.MaDM = 4";
...
<div class="hero-section">
    <img src="../assets/images/depadidas.jpg" alt="Banner chính" class="hero-banner">
=======
    <title>Sản phẩm Dép Adidas</title>
    <link rel="stylesheet" href="../assets/css/style.css">
</head>
<body>
