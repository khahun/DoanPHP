...
$filters = [
    ...
    'brand' => '', // Không lọc theo hãng trên trang tất cả sản phẩm
    'gender' => $_GET['gender'] ?? '',
    'size' => $_GET['size'] ?? '',
...
<div class="hero-section">
    <!-- Có thể thêm banner chung nếu có -->
    <img src="assets/images/main-banner.jpg" alt="Banner chính" class="hero-banner">
</div>
