...
$sql = "SELECT s.*, a.Anh1, d.TenDM 
        ...
        WHERE n.TenNCC = 'PUMA' AND d.TenDM LIKE '%DÉP%'";
...
$sql = "SELECT sp.MaSP, sp.TenSP, sp.DonGia, sp.AnhNen
        ...
        WHERE ncc.TenNCC = 'PUMA' AND sp.MaDM = 4";
...
<div class="hero-section">
    <img src="../assets/images/deppuma.jpg" alt="Banner chính" class="hero-banner">
=======
    <title>Sản phẩm Dép Puma</title>
    <link rel="stylesheet" href="../assets/css/style.css">
</head>
<body>
...
<div class="hero-section">
    <img src="../assets/images/BannerP.jpg" alt="Banner chính" class="hero-banner">
>>>>>>> 9934819e0c09fc0f54bcd0b6242e6210abb6e70a
</div>
...
=======
             <l><a href="Adidas.php">ADIDAS</a></li>
>>>>>>> 9934819e0c09fc0f54bcd0b6242e6210abb6e70a
        ...
        <form method="GET" action="" class="filter-form">
            ...
            <div class="filter-group">
                ...
                <select name="category">
                    ...
                    <?php
                    $cat_sql = "SELECT * FROM danhmuc WHERE TenDM IN ('Sản phẩm nổi bật', 'Sản phẩm mới', 'Sản phẩm bán chạy')";
