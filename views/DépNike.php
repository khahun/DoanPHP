...
$sql = "SELECT s.*, a.Anh1, d.TenDM 
        ...
        WHERE n.TenNCC = 'NIKE' AND d.TenDM LIKE '%DÉP%'";
...
$sql = "SELECT sp.MaSP, sp.TenSP, sp.DonGia, sp.AnhNen
        ...
        WHERE ncc.TenNCC = 'NIKE' AND sp.MaDM = 4";
...
<div class="hero-section">
    <img src="../assets/images/depnike.jpg" alt="Banner chính" class="hero-banner">
=======
    <title>Sản phẩm Dép Nike</title>
    <link rel="stylesheet" href="../assets/css/style.css">
</head>
<body>
...
<div class="hero-section">
    <img src="../assets/images/BannerN.jpg" alt="Banner chính" class="hero-banner">
>>>>>>> 9934819e0c09fc0f54bcd0b6242e6210abb6e70a
</div>
